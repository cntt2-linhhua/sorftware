export const homeDoc = {
    home: 'Trang chủ',
    subTitilePage: 'NHÀ THIẾT KẾ VÀ KIẾN TRÚC TỐT NHẤT', // BEST DESIGNERS & ARCHITECTORS
    titlePage: 'Tạo dựng \n Ngôi nhà mơ ước trong tương lai của bạn', // Creating Your Future Dream Home
    btnMore: 'KHÁM PHÁ NHIỀU HƠN', // DISCOVER MORE
    aboutUs: 'VỀ CHÚNG TÔI', // ABOUT US
    ...
    experience: 'KINH NGHIỆM', // YEARS OF EXPERIENCE
    officeWorldWide: 'VĂN PHÒNG TRÊN TOÀN THẾ GIỚI', // OFFICES WORLDWIDE
    ourServices: 'DỊCH VỤ CỦA CHÚNG TÔI', //OUR SERVICES
    whatCanWeOffer: 'Chúng tôi có thể cung cấp', // What Can We Offer
    designPlanning: 'Lên kế hoạch & Thiết kế', // Design & Planning
    subDesignPlanning: 'Không ai có thể giết chết một yếu tố nào đó bằng hai mũi tên.', // Elementum aliquam byuerirra sagittis duis non quis.
    customSolutions: 'Thiết kế tuỳ theo yêu cầu', // Custom Solutions
    subCustomSolutions: 'Không ai có thể giết chết một yếu tố nào đó bằng hai mũi tên.', // Elementum aliquam byuerirra sagittis duis non quis.
    FurnitureDecor: 'Nội thất & Trang trí', // Furniture & Decor
    ExteriorDesign: 'Thiết kế bên ngoài', // Exterior Design
    InteriorDesign: 'Thiết kế nội thất', // Interior Design
    ConceptPlanning: 'Lập kế hoạch ý tưởng', // Concept Planning
    OURPROJECTS: 'CÁC DỰ ÁN CỦA CHÚNG TÔI', // OUR PROJECTS
    LatestProjectWeDesigned: 'Dự án mới nhất chúng tôi thiết kế', // Latest Project We Designed
    ModernArchitectureInLondon: 'Kiến trúc hiện đại ở London', // Modern Architecture in London
    InteriorDesignInSanFrancisco: 'Thiết kế nội thất ở San Francisco', // Interior Design in San Francisco
    ExclusiveHomeDecorInCalifornia: '', // Exclusive Home Decor in California
    OUR_PROFESSIONALS: 'CHUYÊN GIA CỦA CHÚNG TÔI', // OUR PROFESSIONALS
    MeetOurSkilledTeam: 'Gặp gỡ đội ngũ lành nghề của chúng tôi', // Meet Our Skilled Team
    descriptionTeam: 'Chúng tôi cam kết luôn cố gắng để có thể trở thành người đồng hành tin cậy của các gia chủ trong hành trình kiến tạo một tôt ấm đẳng cấp, khác biệt', // Ac sollicitudin euismod ut luctus felis duis lacus sed pellentesque. Purus eget consectetur massa amet. Hac diam suspendisse in faucibus posuere dignissim amet at. Eget vitae magna condimentum lorem tristique scelerisque ornare.
    MarketingCoordinator: 'Điều phối viên Marketing', // Marketing Coordinator
    ...
    TheGoldenRatio2DSketch: 'Bản phác thảo 2D tỷ lệ vàng', // The Golden Ratio 2D Sketch
